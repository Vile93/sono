...
const Client = ({ icon, name }: Props) => {
    return (
        <div className="flex-1 bg-linear-to-br from-slate-800 to-slate-900 rounded-2xl border border-white/10 overflow-hidden shadow-2xl flex items-center justify-center group relative">
